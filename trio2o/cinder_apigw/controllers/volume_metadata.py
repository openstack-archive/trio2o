...
class VolumeMetaDataController(rest.RestController):
    ...
    def post(self, **kw):
        ...
        try:
            ...
            LOG.exception(_('Fail to create metadata for a volume:'
                            '%(volume_id)s'
                            '%(exception)s'),
                          {'volume_id': self.volume_id,
                           'exception': e})
    ...
    def get_one(self):
        ...
        try:
            ...
            LOG.exception(_('Fail to get metadata for a volume:'
                            '%(volume_id)s'
                            '%(exception)s'),
                          {'volume_id': self.volume_id,
                           'exception': e})
    ...
    def put(self, **kw):
        ...
        try:
            ...
            LOG.exception(_('Fail to update metadata for a volume: '
                            '%(volume_id)s'
                            '%(exception)s'),
                          {'volume_id': self.volume_id,
                           'exception': e})
    ...
    def delete(self, key):
        ...
        try:
            ...
            LOG.exception(_('Fail to delete metadata from a volume: '
                            '%(volume_id)s'
                            '%(exception)s'),
                          {'volume_id': self.volume_id,
                           'exception': e})
