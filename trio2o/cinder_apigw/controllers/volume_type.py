...
class VolumeTypeController(rest.RestController):
    ...
    def post(self, **kw):
        ...
        with session.begin():
            ...
            try:
                ...
                LOG.exception(_('Fail to create volume type: %(name)s,'
                                '%(exception)s'),
                              {'name': vol_type['name'],
                               'exception': e})
                return utils.format_cinder_error(
    ...
    def get_one(self, _id):
        ...
        try:
            ...
            LOG.exception(_('Volume type not found: %(id)s,'
                            '%(exception)s'),
                          {'id': _id,
                           'exception': e})
            return utils.format_cinder_error(
    ...
    def get_all(self):
        ...
        try:
            ...
            LOG.exception(_('Fail to retrieve volume types: %(exception)s'),
                          {'exception': e})
    ...
    def put(self, _id, **kw):
        ...
        try:
            ...
            LOG.exception(_('Fail to update volume type: %(name)s,'
                            '%(exception)s'),
                          {'name': values['name'],
                           'exception': e})
            return utils.format_cinder_error(
    ...
    def delete(self, _id):
        ...
        with session.begin():
            ...
            try:
                ...
                LOG.exception(_('Fail to update volume type: %(id)s,'
                                '%(exception)s'),
                              {'id': _id,
                               'exception': e})
                return utils.format_cinder_error(
