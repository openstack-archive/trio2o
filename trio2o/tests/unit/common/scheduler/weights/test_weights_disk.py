...
class TestDiskWeigher(unittest.TestCase):
    def setUp(self):
        cfg.CONF.clear()
    ...
    def _get_all_pod_state_objects(self, count=2):
        ...
        for i in xrange(1, count + 1):
            pod_name = 'bottom_pod_00' + str(i)
            az_name = 'az_name_00' + str(i)
    ...
    def test_default_of_spreading_first(self):
        ...
        # pod1: free_disk_gb=4G*1
        # pod2: free_disk_gb=4G*2
        # pod3: free_disk_gb=4G*3
        ...
        self.assertEqual('bottom_pod_003', pod['pod_name'])

    def test_disk_filter_multiplier1(self):
        disk_weight_multiplier_backup = cfg.CONF.disk_weight_multiplier
        cfg.CONF.set_override('disk_weight_multiplier', 0.0)
        ...
        cfg.CONF.set_override('disk_weight_multiplier',
                              disk_weight_multiplier_backup)

    def test_disk_filter_multiplier2(self):
        disk_weight_multiplier_backup = cfg.CONF.disk_weight_multiplier
        cfg.CONF.set_override('disk_weight_multiplier', 2.0)
    ...
    def test_disk_filter_negative(self):
        disk_weight_multiplier_backup = cfg.CONF.disk_weight_multiplier
        cfg.CONF.set_override('disk_weight_multiplier', -1.0)

        pod_object_list = self._get_all_pod_state_objects(3)
        # pod1: free_disk_gb=4G*1
        # pod2: free_disk_gb=4G*2
        # pod3: free_disk_gb=4G*3
        # pod4: free_disk_gb=4G*4
        ...
        pod = db_api.get_pod_by_pod_id(self.context, weighed_pod.obj['pod_id'])
        self.assertEqual('bottom_pod_001', pod['pod_name'])
