...
class ServerController(rest.RestController):
    ...
    def _process_injected_file_quota(self, context, t_server_dict):
        try:
            ...
            msg = str(e)
            LOG.exception(_('Quota exceeded %(msg)s'), {'msg': msg})
