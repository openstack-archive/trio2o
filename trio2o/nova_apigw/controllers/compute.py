...
class ComputeController(rest.RestController):

    def __init__(self, project_id):
        self.project_id = project_id
        self.client = t_client.Client()

    def _construct_show_compute_entry(self, compute):
        return {
            'id': compute['id'],
    ...
    def get_all(self, **kwargs):
        ...
        ret_services = [self._construct_show_compute_entry(
            image) for image in services]
