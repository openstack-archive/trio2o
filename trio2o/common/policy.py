...
"""Policy Engine For Trio2o."""

# Policy controlled API access mainly for the Trio2o Admin API. Regarding
...
# these APIs processing will be terminated at the Trio2o layer, so policy
# control should be done by Nova API-GW or Cinder API-GW. No work is required
# to do in the Trio2o Neutron Plugin for Neutron API server is there,
