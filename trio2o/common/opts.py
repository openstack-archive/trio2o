...
import trio2o.common.scheduler.manager
...
def list_opts():
    return [
        ...
        ('filter_scheduler',
         trio2o.common.scheduler.filter_scheduler.filter_scheduler_opts)
        ('scheduler', trio2o.common.scheduler.manager.scheduler_opts)
